...
class OrderGoods extends BaseModel {
    ...
    protected $guarded = [];
    protected $appends = ['id', 'product', 'property', 'attachment', 'total_amount', 'total_price', 'product_price', 'is_reviewed', 'cat_id'];
    protected $visible = ['id', 'product', 'property', 'attachment', 'total_amount', 'total_price', 'product_price', 'is_reviewed', 'cat_id' ];
...
//	    ->sum('goods_number');
    ...
    {
        return \DB::table('goods')->where('goods_id', $this->attributes['goods_id'])->select('cat_id')->first()->cat_id;
    }
