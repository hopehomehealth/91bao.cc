<?php
namespace App\Services\Payment\AlipayWap\aop;
	...
	*/
	public function pageExecute($request,$httpmethod = "POST") {
		...
		if (method_exists($request,"getNeedEncrypt") &&$request->getNeedEncrypt()){
			...
			// 执行加密
			$enCryptContent = encryptnew($apiParams['biz_content'], $this->encryptKey);
	...
	private function encryptJSONSignSource($request, $responseContent) {
		...
		$bizContent = decryptnew($parsetItem->encryptContent, $this->encryptKey);
