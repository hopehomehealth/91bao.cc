 ...
 */
namespace App\Services\Payment\AlipayWap\wappay\service;
use App\Services\Payment\AlipayWap\aop\AopClient;
use App\Services\Payment\AlipayWap\aop\request\AlipayTradeWapPayRequest;
...
//			echo $result;
	 ...
	 * @param $signtype 验签方式。
	 * @param $alipay_public_key 验签支付宝公钥。
	 * @return boolean
	 */
	public static function check($arr, $signtype, $alipay_public_key){
		$aop = new AopClient();
		$aop->alipayrsaPublicKey = $alipay_public_key;
		$result = $aop->rsaCheckV1($arr, $alipay_public_key, $signtype);
		return $result;
	}
