...
if (! function_exists('insert_order_sn')) {
    function insert_order_sn($order_id, $order_amount)
    {
		$id = DB::table('pay_log')->insertGetId(['order_id' => $order_id, 'order_amount' => $order_amount]);
		return $id;
    }
}
