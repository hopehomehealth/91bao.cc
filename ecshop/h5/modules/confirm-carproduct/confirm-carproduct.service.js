(function () {
    ...
    angular
        .module('app')
        .factory('ConfirmCarproductService', ConfirmCarproductService);

    ConfirmCarproductService.$inject = ['$http', '$q', '$timeout', 'CacheFactory', 'ENUM', '$rootScope'];

    function ConfirmCarproductService($http, $q, $timeout, CacheFactory, ENUM, $rootScope) {
