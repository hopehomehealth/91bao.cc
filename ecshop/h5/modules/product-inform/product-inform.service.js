(function () {
    ...
    angular
        .module('app')
        .factory('ProductInformService', ProductInformService);

    ProductInformService.$inject = ['$http', '$q', '$timeout', 'CacheFactory', 'ENUM', '$rootScope'];

    function ProductInformService($http, $q, $timeout, CacheFactory, ENUM, $rootScope) {
