(function () {
    ...
    angular
        .module('app')
        .factory('CouponModel', CouponModel);

    CouponModel.$inject = ['$http', '$q', '$timeout', '$rootScope', 'CacheFactory', 'AppAuthenticationService', 'API', 'ENUM'];

    function CouponModel($http, $q, $timeout, $rootScope, CacheFactory, AppAuthenticationService, API, ENUM) {
