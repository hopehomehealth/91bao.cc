(function () {
    ...
    function APIProductService($http, $q, $timeout, CacheFactory, ENUM) {
        ...
        //添加车险订单接口 @wuwp 20170608
        service.purchaseCar = _purchaseCar;
        return service;
        ...
        //添加车险订单的接口
        function _purchaseCar(params) {
            return this.fetch('/v2/ecapi.product.purchase.car', params, false, function(res){
                return ENUM.ERROR_CODE.OK == res.data.error_code ? res.data.order : null;
            });
        }
