(function () {
    ...
    function APIOrderService($http, $q, $timeout, CacheFactory, ENUM) {
        ...
        //个人中心-车险保单-数量详情
        service.subcartotal = _subcartotal;
        ...
        //个人中心-车险订单-数量详情
        function _subcartotal(params) {
            return this.fetch('', params, false, function () {
                return ENUM.ERROR_CODE.OK == res.data.error_code ? res.data.subcartotal : null;
            });
        }
    }
