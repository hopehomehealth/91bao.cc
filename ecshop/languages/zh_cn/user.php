...
$_LANG['label_address'] = '常用联系人';
$_LANG['label_message'] = '我的留言';
$_LANG['label_tag'] = '我的代金券';
...
$_LANG['city'] = '城市';
$_LANG['area'] = '所在区域';
$_LANG['card_type'] = '证件类型';
$_LANG['card_num'] = '证件号码';

$_LANG['search_ship'] = '查看支持的配送方式';

$_LANG['del_address_false'] = '删除收货地址失败！';
$_LANG['add_address_success'] = '添加联系人成功！';
$_LANG['edit_address_success'] = '您的联系人信息已成功更新！';
$_LANG['address_list_lnk'] = '返回地址列表';
$_LANG['add_address'] = '新增常用联系人';
$_LANG['confirm_edit'] = '确认修改';

$_LANG['confirm_drop_address'] = '你确认要删除该联系人吗？';
...
$_LANG['agreement'] = "我已看过并接受《<a href=\"article.php?id=6\" style=\"color:blue\" target=\"_blank\">用户协议</a>》";
/* href=\"article.php?cat_id=-1\" 用户协议链接0705*/
...
/*密码超长判断*/
$_LANG['passport_js']['password_longer'] = '* 登录密码不能多于 18 个字符。';
