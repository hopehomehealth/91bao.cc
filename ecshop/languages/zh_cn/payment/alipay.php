...
$_LANG['alipay'] = '支付宝';
$_LANG['alipay_desc'] = '支付宝网站(www.alipay.com) 是国内先进的网上支付平台。<br/>支付宝收款接口：在线即可开通，零预付，免年费，单笔阶梯费率，无流量限制。<br/><a href="https://b.alipay.com/order/productDetail.htm?productId=2015110218012942" target="_blank">立即在线申请</a>';
$_LANG['alipay_account'] = '支付宝帐户';
$_LANG['alipay_key'] = '交易安全校验码';
$_LANG['alipay_partner'] = '合作者身份ID';
$_LANG['pay_button'] = '立即支付';

//$_LANG['alipay_pay_method'] = '接口类型';
//$_LANG['alipay_pay_method_desc'] = '';
//$_LANG['alipay_pay_method_range'][0] = '免费签约接口';
//$_LANG['alipay_pay_method_range'][1] = '预付费签约接口';
