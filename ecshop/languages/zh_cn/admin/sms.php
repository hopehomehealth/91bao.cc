...
$_LANG['error_tips'] = '请用云起账号登陆后台，进行设置！';
...
$_LANG['default_succ'] = '签名默认成功';
$_LANG['no_default'] = '未有此默认值';
$_LANG['add_sign'] = '新添短信签名';
$_LANG['new_default_sign'] = '当前默认签名为';
$_LANG['default_sign'] = '原签名';
$_LANG['add'] = '添加';
$_LANG['edited'] = '修改为';
$_LANG['edit'] = '修改';
