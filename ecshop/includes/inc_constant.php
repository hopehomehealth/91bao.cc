...
define('OS_CONFIRMED',              1); // 已确认 保障中
define('OS_CANCELED',               2); // 已取消 订单超时
define('OS_INVALID',                3); // 过保了 待续保
define('OS_RETURNED',               4); // 退款
define('OS_SPLITED',                5); // 订单删除 前台不显示
define('OS_SPLITING_PART',          6); // 暂时保留
