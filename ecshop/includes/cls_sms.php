...
class sms
{
    ...
    function send_alidayu($phones,$msg,$send_date = '', $send_num = 1,$sms_type='',$version='1.0'){
        include_once("Alidayu/top/RequestCheckUtil.php");
        include_once("Alidayu/top/ResultSet.php");
        include_once("Alidayu/top/TopClient.php");
        include_once("Alidayu/top/request/AlibabaAliqinFcSmsNumSendRequest.php");
        $res =array();
        $c = new TopClient;
        $c->appkey = '23812911';
        $c->secretKey = 'f7e57d998808802a7fb89e146720805d';
        $req = new \AlibabaAliqinFcSmsNumSendRequest;
        $req->setExtend('vpn');
        $req->setSmsType("normal");
        $req->setSmsFreeSignName("外贸浏览器");
        $req->setSmsParam("{code:'$msg',product:'外贸浏览器'}");
        $req->setRecNum($phones);
        $req->setSmsTemplateCode("SMS_66685059");
        try {
            $resp = $c->execute($req);
            $ret = $resp->result->err_code;
    ...
    function send_alidayu_phone_login($phones,$msg,$send_date = '', $send_num = 1,$sms_type='',$version='1.0'){
        include_once("Alidayu/top/RequestCheckUtil.php");
        include_once("Alidayu/top/ResultSet.php");
        include_once("Alidayu/top/TopClient.php");
        include_once("Alidayu/top/request/AlibabaAliqinFcSmsNumSendRequest.php");
    ...
    function send_alidayu_car($phones,$msg,$send_date = '', $send_num = 1,$sms_type='',$version='1.0'){
        include_once("Alidayu/top/RequestCheckUtil.php");
        include_once("Alidayu/top/ResultSet.php");
        include_once("Alidayu/top/TopClient.php");
        include_once("Alidayu/top/request/AlibabaAliqinFcSmsNumSendRequest.php");
