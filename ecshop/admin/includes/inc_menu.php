...
$modules['02_cat_and_goods']['07_goods_combo_list'] = 'combo.php?act=list';
$modules['02_cat_and_goods']['09_health_notice_list'] = 'health_notice.php?act=list';
...
$modules['08_members']['07_coupon']                 = 'coupon.php?act=list';
...
$modules['18_lead_manage']['lead']                 = 'mobile_setting.php?act=list';//H5店铺二维码
$modules['18_lead_manage']['leancloud']            = 'mobile_setting.php?act=list';//云推送管理
$modules['18_lead_manage']['mobile_setting']       = 'ecmobile_setting.php?act=list';//移动版应用配置
$modules['18_lead_manage']['h5_setting']           = 'mobile_setting.php?act=list';//移动版应用配置
$modules['18_lead_manage']['wxa_setting']          = 'mobile_setting.php?act=list';//小程序应用配置
